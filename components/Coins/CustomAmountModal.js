    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end z-50">
      <div className="bg-white w-full rounded-t-2xl animate-slide-up">
        ...
        <div className="relative text-center p-4 border-b border-gray-200">
          <button onClick={onClose} className="absolute left-4 top-1/2 -translate-y-1/2 text-2xl font-light">&times;</button>
        ...
        <div className="p-6 text-center">
          <div className="flex items-center justify-center space-x-2">
            ...
            <span className="text-4xl font-bold tracking-wider h-12">
